...
public class BackgroundService extends Service implements AccelerometerListener{
            ...
            if (flag ==0) {
                switch (message.what) {
                    case 1:
                        ...
                        // SMSManager tmgr=(SMSManager)BackgroundService.this.getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public void onShake(float force) {
        flag = 0;
        GPSTrack gps;
        gps = new GPSTrack(BackgroundService.this);
        if(gps.canGetLocation()){

            double latitude = gps.getLatitude();
            double longitude = gps.getLongitude();

            EGeocoder RGeocoder = new EGeocoder();
    ...
    private void sendNotification(String msg) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, Alerts.class), 0);
