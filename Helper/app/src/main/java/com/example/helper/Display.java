...
public class Display extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alertDialogBuilder.setPositiveButton("I'm fine", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                Toast.makeText(getApplicationContext(), "Emergency Call Averted!", Toast.LENGTH_SHORT).show();
					Intent i_view = new Intent(Display.this, BackgroundService.class);
					startActivity(i_view);
                BackgroundService.flag = 1;
            }
        });
        alertDialogBuilder.setNegativeButton("I'm hurt!", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {

                Toast.makeText(getApplicationContext(), "Notifying Emergency Contacts!", Toast.LENGTH_SHORT).show();
        ...
        this.c=db.rawQuery("SELECT * FROM details", null);
        if(c.getCount()==0)
        {
        ...
        Intent i_startservice=new Intent(Display.this,BackgroundService.class);
