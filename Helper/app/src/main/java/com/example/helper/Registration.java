...
public class Registration extends Activity {
    ...
    public void display(View v) {
        Intent i_view=new Intent(Registration.this,Display.class);
        startActivity(i_view);

    }

    public void instructions(View v) {
        Intent i_help=new Intent(Registration.this,Instructions.class);
    ...
    public void storeInDB(View v) {
        ...
        number = (EditText) this.findViewById(R.id.phone);
